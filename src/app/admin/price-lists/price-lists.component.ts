...
export class PriceListsComponent implements OnInit {
  ...
  delete(priceList: PriceListModel) {
    this.priceListService.delete(priceList).subscribe(
      (res: any) => {
  ...
  add(addForm: NgForm) {
    ...
    this.priceListService.add(priceListModel).subscribe(
      (res: any) => {
  ...
  getPriceList(priceList: PriceListModel) {
    this.priceListService.getById(priceList.id).subscribe(
      (res: any) => {
