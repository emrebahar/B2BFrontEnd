...
export class PriceListDetailComponent implements OnInit {
  ...
  getList() {
    this.priceListDetailService.getList(this.priceListId).subscribe(
      (res: any) => {
  ...
  delete(priceListDetail: PriceListDetailModel) {
    this.priceListDetailService.delete(priceListDetail).subscribe(
      (res: any) => {
  ...
  add(addForm: NgForm) {
    ...
    this.priceListDetailService.add(priceListDetail).subscribe(
      (res: any) => {
  ...
  update(priceListDetail: PriceListDetailModel) {
    this.priceListDetailService.update(priceListDetail).subscribe(
      (res: any) => {
        this.toastr.success(res.message);
        this.getList();
