...
export class CustomersComponent implements OnInit {
  ...
  getPriceList() {
    this.priceListService.getList().subscribe(
      (res: any) => {
  ...
  getCustomer(customer: CustomerModel) {
    this.customerService.GetDtoById(customer.id).subscribe(
      (res: any) => {
  ...
  updateRelationShip() {
    ...
    this.customerService.updateRelationship(model).subscribe(
      (res: any) => {
        this.toastr.info(res.message);
        this.getList();
  ...
  changePassword() {
    ...
    this.customerService.changePasswordByAdminPanel(customer).subscribe(
      (res: any) => {
        this.toastr.info(res.message);
        this.getList();
