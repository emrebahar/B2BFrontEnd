      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadChildren: () =>
              import(
                './admin/products/product-images/product-images.module'
        ...
        children: [
          {
            ...
            loadChildren: () =>
              import('./admin/price-lists/price-lists.module').then(
                (m) => m.PriceListsModule
              ),
          },
          {
            path: ':id',
            ...
            loadChildren: () =>
              import(
                './admin/price-lists/price-list-detail/price-list-detail.module'
        ...
        children: [
          {
            ...
            loadChildren: () =>
              import('./admin/customers/customers.module').then(
                (m) => m.CustomersModule
              ),
          },
        ],
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadChildren: () =>
              import('./admin/orders/order-detail/order-detail.module').then(
